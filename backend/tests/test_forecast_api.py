...
def test_post_forecast(client):
    ...
    assert response.json() == {
        "id": 1, "user_id": 1, "epic_id": 1, "client_id": 1, "days": 10, "month": 5, "year": 2022
    }
...
def test_update_forecasts(client):
    response = client.put("api/forecasts/new-days?user_id=1&epic_id=1&month=5&year=2022&days=1")
    assert response.json() == {
        "id": 1, "user_id": 1, "epic_id": 1, "client_id": 1, "days": 1, "month": 5, "year": 2022
    }
